/**
 * @file    FiberSim_thin_filament.cpp
 * @brief   Source file for the FiberSim_thin_filament class
 * @author  Ken Campbell
 */
...
// Constructor
FiberSim_thin_filament::FiberSim_thin_filament(
    FiberSim_half_sarcomere* set_p_parent_hs,
    int set_thin_id)
{
    // Initialise
    ...
    p_fs_model = p_parent_hs->p_fs_model;
    p_fs_options = p_parent_hs->p_fs_options;
...
void FiberSim_thin_filament::initialise_bs_x_bs_angle_bs_unit(void)
{
...
void FiberSim_thin_filament::set_unit_status(void)
{
...
void FiberSim_thin_filament::set_regulatory_unit_indices(int unit_ind, gsl_vector_short* bs_indices)
{
...
void FiberSim_thin_filament::calculate_node_forces(void)
{
    //! Sets the node force

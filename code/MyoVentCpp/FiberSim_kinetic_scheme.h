...
public:
	...
	FiberSim_m_state* p_m_states[MAX_NO_OF_KINETIC_STATES];
	...
	*/
	FiberSim_kinetic_scheme(const rapidjson::Value& m_ks, FiberSim_model* set_p_fs_model,
		FiberSim_options* set_p_fs_options);

	/**
	* Destructor
	*/
	~FiberSim_kinetic_scheme(void);

...
struct FiberSim_force_control_params
{
	double target_force;
	double time_step;
	FiberSim_half_sarcomere* p_hs;
};
...
struct lattice_event
{
	...
	FiberSim_transition* p_trans;   // transition
};
...
FiberSim_half_sarcomere::FiberSim_half_sarcomere(FiberSim_muscle* set_p_parent_fs_muscle, int set_hs_id)
{
    ...
    gsl_rng_set(rand_generator,
        unsigned long((hs_id + 1) + time_seed));
    ...
    {
        p_mf[m_counter] = new FiberSim_thick_filament(
            this,
            m_counter);
    }
    ...
    {
        p_af[a_counter] = new FiberSim_thin_filament(
            this,
            a_counter);
    }
...
void FiberSim_half_sarcomere::sarcomere_kinetics(double time_step, double set_pCa)
{
...
size_t FiberSim_half_sarcomere::update_lattice(double time_step, double delta_hsl)
{
...
size_t FiberSim_half_sarcomere::update_lattice_for_force(double time_step, double target_force)
{
...
size_t FiberSim_half_sarcomere::implement_time_step(double time_step,
...
double FiberSim_half_sarcomere::return_hs_length_for_force(double target_force, double time_step)
{
...
double FiberSim_half_sarcomere::calculate_delta_hsl_for_force(double target_force, double time_step)
{
    ...
    struct FiberSim_force_control_params params = { target_force, time_step, this };
...
double FiberSim_half_sarcomere::test_force_wrapper(double delta_hsl, void* params)
{
    struct FiberSim_force_control_params* p =
        (struct FiberSim_force_control_params*)params;
    FiberSim_half_sarcomere* p_hs = p->p_hs;
...
double FiberSim_half_sarcomere::return_force_for_test_delta_hsl(double delta_hsl, double time_step_s = 0.0)
{
    // Variables
    ...
    calculate_x_positions();
    test_force = calculate_force(delta_hsl, time_step_s);
...
double FiberSim_half_sarcomere::test_force_for_delta_hsl(double delta_hsl, void* params)
{
...
void FiberSim_half_sarcomere::initialize_tridiagonal_vectors(void)
{
...
void FiberSim_half_sarcomere::calculate_g_vector(gsl_vector* x_trial)
{
...
void FiberSim_half_sarcomere::calculate_df_vector(gsl_vector* x_trial)
{
...
size_t FiberSim_half_sarcomere::calculate_x_positions()
{
...
void FiberSim_half_sarcomere::initialise_filament_y_z_coordinates(int m_n)
{
...
void FiberSim_half_sarcomere::initialise_nearest_actin_matrix(void)
{
...
void FiberSim_half_sarcomere::initialise_f0_vector(void)
{
...
void FiberSim_half_sarcomere::unpack_x_vector(void)
{
...
void FiberSim_half_sarcomere::calculate_mean_filament_lengths(void)
{
...
void FiberSim_half_sarcomere::calculate_a_pops(void)
{
...
void FiberSim_half_sarcomere::calculate_m_pops(void)
{
    //! Updates the vector holding the proportion of 
...
void FiberSim_half_sarcomere::calculate_c_pops(void)
{
...
double FiberSim_half_sarcomere::calculate_force(double delta_hsl, double time_step)
{
...
double FiberSim_half_sarcomere::calculate_viscous_force(double delta_hsl, double time_step)
{
...
double FiberSim_half_sarcomere::calculate_titin_force(void)
{
...
double FiberSim_half_sarcomere::calculate_extracellular_force(void)
{
...
void FiberSim_half_sarcomere::update_f0_vector(double delta_hsl)
{
...
int FiberSim_half_sarcomere::node_index(char molecule_type, int filament_index, int n_index)
{
...
void FiberSim_half_sarcomere::set_cb_nearest_a_f(void)
{
...
void FiberSim_half_sarcomere::set_cb_nearest_a_n(void)
{
...
void FiberSim_half_sarcomere::set_pc_nearest_a_f(void)
{
    //! Code sets the nearest_f
...
void FiberSim_half_sarcomere::set_pc_nearest_a_n(void)
{
...
void FiberSim_half_sarcomere::thick_filament_kinetics(double time_step)
{
...
void FiberSim_half_sarcomere::myosin_kinetics(double time_step)
{
    ...
    FiberSim_m_state* p_m_state;                 // pointer to a myosin state
...
int FiberSim_half_sarcomere::return_m_transition(double time_step, int m_counter, int cb_counter)
{
...
int FiberSim_half_sarcomere::return_c_transition(double time_step, int m_counter, int pc_counter)
{
    ...
    FiberSim_m_state* p_c_state;             // pointer to a state
    FiberSim_transition* p_trans;            // pointer to a transition
...
void FiberSim_half_sarcomere::handle_lattice_event(lattice_event* p_event)
{
...
void FiberSim_half_sarcomere::thin_filament_kinetics(double time_step, double Ca_conc)
{
...
int FiberSim_half_sarcomere::return_event_index(gsl_vector* prob)
{
...
void FiberSim_half_sarcomere::write_gsl_spmatrix_to_file(gsl_spmatrix* p_sparse_matrix, char output_file_string[])
{
...
void FiberSim_half_sarcomere::write_gsl_vector_to_file(gsl_vector* p_vector, char output_file_string[])
{
...
void FiberSim_half_sarcomere::write_hs_status_to_file(char output_file_string[])
{
...
void FiberSim_half_sarcomere::extract_digits(string test_string, int digits[], int no_of_digits)
{

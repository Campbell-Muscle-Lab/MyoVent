...
/**
 * @file    FiberSim_thick_filament.h
 * @brief   header file for the FiberSim_thick_filament class
 * @author  Ken Campbell
 */
...
public:
     ...
     * + initialized with:
         ...
         + an id number
     */
    FiberSim_thick_filament(
        FiberSim_half_sarcomere* p_parent_hs,
        int set_thick_id);

    /**
    * Destructor
    */
    ~FiberSim_thick_filament(void);
    ...
    */
    ...
    FiberSim_half_sarcomere* p_parent_hs;        /**< Pointer to the parent half-sarcomere */

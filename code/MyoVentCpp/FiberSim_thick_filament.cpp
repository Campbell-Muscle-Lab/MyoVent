...
// Constructor
FiberSim_thick_filament::FiberSim_thick_filament(
...
void FiberSim_thick_filament::initalise_cb_x_and_cb_angle(void)
{
...
void FiberSim_thick_filament::initalise_pc_node_index_and_pc_angle(void)
{
...
void FiberSim_thick_filament::initialise_cb_controlling_pc_index(void)
{
...
void FiberSim_thick_filament::calculate_node_forces(void)
{
    //! Sets the node force

...
class FiberSim_thick_filament;
class FiberSim_thin_filament;
...
public:
    ...
    FiberSim_options* p_fs_options; /**< pointer to FiberSim options */

    cmv_results* p_cmv_results_beat;
                                    /**< pointer to a results object */
    ...
    FiberSim_thick_filament* p_mf[MAX_NO_OF_THICK_FILAMENTS];
    ...
    FiberSim_thin_filament* p_af[MAX_NO_OF_THIN_FILAMENTS];
    ...
    FiberSim_kinetic_scheme* p_m_scheme[MAX_NO_OF_ISOTYPES];
...
// Titin
    ...
    FiberSim_kinetic_scheme* p_c_scheme[MAX_NO_OF_ISOTYPES];
    ...
    */
    ...
    /**
    * double return_force_for_test_delta_hsl()
    */
    double return_force_for_test_delta_hsl(double delta_hsl, double time_step_s);
